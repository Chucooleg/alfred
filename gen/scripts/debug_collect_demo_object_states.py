...
success_log_entries = {'augmentation': []}
fail_log_entries = {'augmentation': []}
results = {'augmentation': {}}

CollectStates.evaluate(parse_args, r_idx, env, 'augmentation', traj_data, True, success_log_entries, fail_log_entries, results, logger)
