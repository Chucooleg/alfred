    ...
    if os.path.exists(save_folder):
        try:
            ...
            if in_parallel:  # another thread succeeded at this task while this one failed.
                ...
                raise e  # if we're not running in parallel, this is an actual error.
    return True
...
def create_dirs(task_name, seed, obj_repeat):
    ...
    # e.g. pick_cool_then_place_in_recep-LettuceSliced-None-DiningTable-17/traj_T_...../
    task_name_task_id = f'{task_name}/{task_id}/'

    # constants.DATA_SAVE_PATH default: /data_alfred/demo_generated/new_trajectories_T.../
