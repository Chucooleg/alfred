...
if __name__ == '__main__':
    ...
    parser.add_argument('--augmentation_lang_model', help='explainer_full or explainer or baseline labeled data', type=str)
    ...
    # parser.add_argument('--autogeneration_lang_model', help='explainer_full or explainer or baseline labeled data', type=str)
    ...
    if args.use_augmentation:
        assert 'augmentation' in splits and len(splits['augmentation']) > 0
    ...
    # start train loop
    model.run_train(splits, args=args, optimizer=optimizer, start_epoch=start_epoch, end_epoch=end_epoch, start_iters=start_iters)