...
# echo '-------------------------------'
# echo 'EVAL Exp 1.1 Unseen Main Script'
# # 1.1 With failure annotation by the explainer
# export AUGMENTATION_LANG_MODEL=explainer
# # training and eval_script
# bash $SCRIPT_HOME/exp_1.1_eval_azvm2_unseen.sh  # remove --fast_epoch add augmentation back

echo '-------------------------------'
echo 'EVAL Exp 1.2 Unseen Main Script'
# 1.2 With failure annotation by the baseline
export AUGMENTATION_LANG_MODEL=baseline
bash $SCRIPT_HOME/exp_1.2_eval_azvm2_unseen.sh
...
# bash $SCRIPT_HOME/exp_2_eval_azvm2_unseen.sh
