...
# bash $SCRIPT_HOME/exp_1.1_eval_azvm_seen.sh  # remove --fast_epoch add augmentation back

echo '-------------------------------'
echo 'EVAL Exp 1.2 Seen Main Script'
# 1.2 With failure annotation by the baseline
export AUGMENTATION_LANG_MODEL=baseline
bash $SCRIPT_HOME/exp_1.2_eval_azvm_seen.sh
...
# bash $SCRIPT_HOME/exp_2_eval_azvm_seen.sh
