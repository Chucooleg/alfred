...
export MODEL_NAME=experiment_3_original_train_set_halved_plus_other_half_annotated_by_$AUTOGENERATION_LANG_MODEL
...
# python models/train/train_seq2seq_agent.py --data $DATA --model $MODEL --dout $DOUT --splits $SPLITS --pp_folder $PP --gpu --batch 8 --pm_aux_loss_wt 0.1 --subgoal_aux_loss_wt 0.1 --use_autogeneration --autogeneration_data $DATA --autogeneration_lang_model $AUTOGENERATION_LANG_MODEL --save_every_epoch --epoch 27 --resume $DOUT/net_epoch_14.pth --lr 1e-4
...
export AGENT_MODEL=$DOUT/net_epoch_9.pth
