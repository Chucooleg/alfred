...
export SPLITS=$ALFRED_ROOT/data/splits/data_augmentation_experiment1_20200826.json 
...
bash $SCRIPT_HOME/exp_1_train_eval_azvm2.sh  # remove --fast_epoch add augmentation back
